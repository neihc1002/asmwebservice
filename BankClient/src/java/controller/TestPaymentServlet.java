...
public class TestPaymentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String matkhaudoitac =  request.getParameter("matkhaudoitac");
        ...
        String status = client.payment(taikhoankhachhang, matkhaudoitac, amount, pin, makhachhang, madonhang, madoitac);
        if (status.equals("success")) {
            request.getRequestDispatcher("paymentsuccess.jsp").forward(request, response);
        }else{
             request.getRequestDispatcher("paymentfail.jsp").forward(request, response);
        }
    }
